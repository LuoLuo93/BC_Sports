<template>
  <div class="cockpit">
    ...
    <div class="immersive-layout">
      <!-- Left Column: Revenue + Channel + Category -->
      <div class="side-column left-col">
        <div class="panel" style="flex: 2; --anim-delay: 0.25s">
        ...
        <div class="panel" style="flex: 1.2; --anim-delay: 0.45s">
          <div class="panel-corner tl"></div>
          <div class="panel-corner tr"></div>
          <div class="panel-corner bl"></div>
          <div class="panel-corner br"></div>
      ...
      <!-- Center Column: 3D Core + Gauges -->
      <div class="center-column">
        <div class="core-container" style="--anim-delay: 0.30s">
          <div class="panel-corner tl"></div>
          <div class="panel-corner tr"></div>
          <div class="panel-corner bl"></div>
          <div class="panel-corner br"></div>
          ...
          <div class="panel-header core-header">
            <span class="panel-dot"></span>
            <span class="panel-title">HOLOGRAPHIC DATA CORE // 全息数据核心</span>
            <span class="panel-tag">3D ACTIVE</span>
          </div>
          <HolographicEarth class="core-earth" />
        </div>
        <div class="core-gauges" style="--anim-delay: 0.50s">
          <div class="panel-corner tl"></div>
          <div class="panel-corner tr"></div>
          <div class="panel-corner bl"></div>
          <div class="panel-corner br"></div>
          <div class="gauges-inner">
          ...
          <div class="core-kpi-strip">
            <div v-for="(kpi, idx) in coreKpis" :key="kpi.label" class="core-kpi-item">
              <span class="core-kpi-label">{{ kpi.label }}</span>
              <span class="core-kpi-value" :class="kpi.trendClass">{{ kpi.prefix }}{{ kpi.value }}{{ kpi.suffix }}</span>
            </div>
          </div>
        </div>
      </div>

      <!-- Right Column: Customer + Shop -->
      <div class="side-column right-col">
        <div class="panel" style="flex: 2; --anim-delay: 0.55s">
          <div class="panel-corner tl"></div>
          <div class="panel-corner tr"></div>
          <div class="panel-corner bl"></div>
          <div class="panel-corner br"></div>
        ...
        <div class="panel" style="flex: 1.5; --anim-delay: 0.65s">
          <div class="panel-corner tl"></div>
          <div class="panel-corner tr"></div>
          <div class="panel-corner bl"></div>
          <div class="panel-corner br"></div>
...
import HolographicEarth from '@/components/3d/HolographicEarth.vue'
...
// ─── Core KPIs (for center strip) ─────────────────────
const coreKpis = computed(() => {
  const k = kpis.value
  return [
    { label: '营收', value: animatedValues.value[k[0]?.label] || '-', prefix: '¥', suffix: '', trendClass: 'up' },
    { label: '订单', value: animatedValues.value[k[1]?.label] || '-', prefix: '', suffix: '', trendClass: 'up' },
    { label: '客单价', value: animatedValues.value[k[5]?.label] || '-', prefix: '¥', suffix: '', trendClass: 'up' },
    { label: '库存', value: animatedValues.value[k[3]?.label] || '-', prefix: '', suffix: '%', trendClass: 'down' }
  ]
})
...
.core-header {
  ...
  z-index: 10;
  background: linear-gradient(180deg, rgba(4,9,20,0.8) 0%, transparent 100%);
  padding-top: 10px;
}
.core-gauges {
  position: relative;
...
.core-kpi-value.up { color: var(--green); }
.core-kpi-value.down { color: var(--cyan); }
.panel {
  position: relative;
  background: var(--panel-bg);
  backdrop-filter: blur(20px) saturate(150%);
