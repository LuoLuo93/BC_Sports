        ...
        <div class="info-section" style="flex:1;">
          ...
          <div class="info-grid">
            ...
            <div class="info-card editable span-2">
              ...
              <el-input v-model="row.MADEIN" placeholder="请输入产地" size="small" />
            </div>
          </div>
        </div>
        <div class="info-section" style="flex:1;">
...
function computeDirty() {
  ...
  const r = row.value
  const fields = ['EXECUTION_STANDARD', 'EAN13', 'SAFETY_CATEGORY', 'FAB_CODE', 'FAB_ELEMENT', 'AC_CODE', 'ACC_ELEMENT', 'MADEIN']
