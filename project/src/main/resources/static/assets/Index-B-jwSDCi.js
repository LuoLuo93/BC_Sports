...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(e,t,n){let r=new Float32Array(Po),i=new K(0,1,0);return new Oa({name:`SphericalGaussianBlur`,defines:{n:Po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new Oa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xo(){return new Oa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zo(),fragmentShader:`
	...
	`}var Qo=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ji(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:2})),d.position.y=12,d.scale.setScalar(zl),n.add(d);let w=new kn;w.scale.setScalar(zl),w.position.y=-4;let T=new Vr({color:Ll,transparent:!0,opacity:.12,blending:2,depthWrite:!1});[6,8,10,12].forEach(e=>{let t=new $r(new va(e,.03,4,80),T);t.rotation.x=Math.PI/2,w.add(t)});let E=new di({color:Ll,transparent:!0,opacity:.06,blending:2});for(let e=0;e<12;e++){let t=e/12*Math.PI*2;w.add(new yi(new Ar().setFromPoints([new K(0,0,0),new K(Math.cos(t)*12,0,Math.sin(t)*12)]),E))}n.add(w),g=performance.now(),y()}function y(){m=requestAnimationFrame(y);let e=(performance.now()-g)/1e3,t=1-(1-Math.min(e/3,1))**3,r=26*zl;if(i.position.set(0,4*zl-t*2*zl,r-12*zl+t*12*zl),i.lookAt(0,0,0),l&&(l.rotation.y+=.001),u){let t=u.geometry.attributes.position;for(let n=0;n<t.count;n++)t.array[n*3+1]-=.015,t.array[n*3]+=Math.sin(e+n)*.002,t.array[n*3+1]<-4&&(t.array[n*3+1]=16);t.needsUpdate=!0}d&&(d.material.uniforms.uTime.value=e),p.forEach(t=>{let n=(e*t.speed+t.offset)%1;t.dot.position.copy(t.curve.getPoint(n))}),f.forEach((t,n)=>{t.material.opacity=.08+Math.sin(e*.5+n*.5)*.03}),c.render(n,i)}function b(){let e=t.value;if(!e||!i||!c)return;let n=e.clientWidth,r=e.clientHeight;n===0||r===0||(i.aspect=n/r,i.updateProjectionMatrix(),c.setSize(n,r))}return r(()=>{_(),h=new ResizeObserver(()=>b()),t.value&&h.observe(t.value),window.addEventListener(`resize`,b)}),o(()=>{m&&cancelAnimationFrame(m),window.removeEventListener(`resize`,b),h&&h.disconnect(),c&&(c.dispose(),c.domElement.parentNode&&c.domElement.parentNode.removeChild(c.domElement)),n?.traverse(e=>{(e.isMesh||e.isPoints||e.isLine)&&(e.geometry?.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material?.dispose())}),n=null,i=null,c=null,f=[],p=[]}),(e,n)=>(s(),a(`div`,{ref_key:`containerRef`,ref:t,class:`holographic-earth`},null,512))}},[[`__scopeId`,`data-v-4a998f54`]]),Vl={class:`cockpit`},Hl={class:`snow-fall`},Ul={class:`cockpit-header`},Wl={class:`header-center`},Gl={class:`header-sub`},Kl={class:`header-time`},ql=[`title`],Jl={key:0,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`},Yl={key:1,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`},Xl={class:`hud-bar`},Zl={class:`hud-chip`},Ql={class:`hud-chip`},$l={class:`hud-chip cold`},eu={class:`kpi-row`},tu={class:`kpi-label`},nu={class:`kpi-value`},ru={class:`trend-arrow`},iu={class:`trend-sub`},au={class:`immersive-layout`},ou={class:`side-column left-col`},su={class:`panel`,style:{flex:`2`,"--anim-delay":`0.2s`}},cu={class:`panel-body`},lu={class:`panel`,style:{flex:`1`,"--anim-delay":`0.3s`}},uu={class:`panel-body`},du={class:`panel`,style:{flex:`1.2`,"--anim-delay":`0.4s`}},fu={class:`panel-body`},pu={class:`center-column`},mu={class:`core-container`,style:{"--anim-delay":`0.25s`}},hu={class:`core-gauges`,style:{"--anim-delay":`0.45s`}},gu={class:`gauges-inner`},_u={class:`core-kpi-strip`},vu={class:`core-kpi-label`},yu={class:`side-column right-col`},bu={class:`panel`,style:{flex:`2`,"--anim-delay":`0.5s`}},xu={class:`panel-body`},Su={class:`panel`,style:{flex:`1.5`,"--anim-delay":`0.6s`}},Cu={class:`panel-body`},wu=`#0ea5e9`,Tu=`#bae6fd`,Eu=`#10b981`,Du=`#f97316`,Ou=`#8b5cf6`,ku=C(Object.assign({name:`Dashboard`},{__name:`Index`,setup(n){let o=v(!1);function C(){let e=document.querySelector(`.cockpit`);document.fullscreenElement?document.exitFullscreen().then(()=>{o.value=!1}):e.requestFullscreen().then(()=>{o.value=!0})}r(()=>{document.addEventListener(`fullscreenchange`,()=>{o.value=!!document.fullscreenElement})});let T=v(``),E=null;function D(){T.value=new Date().toLocaleString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`,second:`2-digit`})}r(()=>{D(),E=setInterval(D,1e3)}),m(()=>clearInterval(E));function O(e){let t=2+Math.random()*4;return{left:Math.random()*100+`%`,width:t+`px`,height:t+`px`,animationDelay:Math.random()*10+`s`,animationDuration:8+Math.random()*12+`s`,opacity:.15+Math.random()*.35}}let k=v([{label:`今日营收`,target:284600,prefix:`¥`,suffix:``,trend:`+12.5%`,trendClass:`up`,trendSub:`较昨日`},{label:`今日订单`,target:3472,prefix:``,suffix:``,trend:`+8.3%`,trendClass:`up`,trendSub:`较昨日`},{label:`活跃会员`,target:15680,prefix:``,suffix:``,trend:`+3.2%`,trendClass:`up`,trendSub:`较上周`},{label:`滑雪品类占比`,target:38,prefix:``,suffix:`%`,trend:`+2.1%`,trendClass:`up`,trendSub:`较上月`},{label:`门店数量`,target:128,prefix:``,suffix:`家`,trend:`+5`,trendClass:`up`,trendSub:`本季新增`},{label:`客单价`,target:528,prefix:`¥`,suffix:``,trend:`+6.8%`,trendClass:`up`,trendSub:`较上月`},{label:`退货率`,target:2.3,prefix:``,suffix:`%`,trend:`-0.4%`,trendClass:`down`,trendSub:`较上月`}]),A=v({});function j(){k.value.forEach(e=>{ee(e.label,e.target,e.suffix===`%`&&e.target<10?1e3:0)})}r(()=>j());function ee(e,t,n=0){let r=performance.now();function i(a){let o=Math.min((a-r)/2e3,1),s=(1-(1-o)**3)*t;t>=1e4?A.value[e]=(s/1e4).toFixed(1)+`万`:n>0?A.value[e]=s.toFixed(n):A.value[e]=Math.round(s).toLocaleString(),o<1&&requestAnimationFrame(i)}requestAnimationFrame(i)}let te=v([{value:94,max:100,title:`库存周转`,color:[`#0ea5e9`,`#0284c7`]},{value:87,max:100,title:`订单完成率`,color:[`#10b981`,`#0ea5e9`]},{value:15680,max:2e4,title:`会员总数`,color:[`#8b5cf6`,`#0ea5e9`]}]),ne=_(()=>{let e=k.value;return[{label:`营收`,value:A.value[e[0]?.label]||`-`,prefix:`¥`,suffix:``,trendClass:`up`},{label:`订单`,value:A.value[e[1]?.label]||`-`,prefix:``,suffix:``,trendClass:`up`},{label:`客单价`,value:A.value[e[5]?.label]||`-`,prefix:`¥`,suffix:``,trendClass:`up`},{label:`滑雪占比`,value:A.value[e[3]?.label]||`-`,prefix:``,suffix:`%`,trendClass:`up`}]}),M={backgroundColor:`rgba(15,23,42,0.92)`,borderColor:`rgba(255,255,255,0.06)`,borderWidth:1,textStyle:{color:`#e2e8f0`,fontSize:12,fontFamily:`Inter, sans-serif`}},N={axisLine:{lineStyle:{color:`rgba(255,255,255,0.06)`}},axisTick:{show:!1},axisLabel:{color:`rgba(255,255,255,0.35)`,fontSize:10,fontFamily:`Inter, sans-serif`},splitLine:{lineStyle:{color:`rgba(255,255,255,0.05)`}}},re=[`1月`,`2月`,`3月`,`4月`,`5月`,`6月`,`7月`,`8月`,`9月`,`10月`,`11月`,`12月`],ie=v({orders:[1200,1890,1650,2380,2130,2910,2690,3250,3580,3140,3810,4250],revenue:[86,128,95,198,165,241,219,274,296,252,318,362]}),ae=v([{value:735,name:`线上商城`},{value:580,name:`线下门店`},{value:284,name:`经销商`},{value:148,name:`大客户`},{value:96,name:`其他`}]),oe=v([186,324,456,578,842]),P=v([156,198,245,312,389]),se=v([820,960,1050,1280,1150,1420,1360,1580,1690,1520,1780,1950]),ce=_(()=>({color:[wu,Eu],tooltip:{...M,trigger:`axis`},legend:{data:[`订单量`,`营收(万)`],textStyle:{color:`rgba(255,255,255,0.45)`,fontSize:11,fontFamily:`Inter, sans-serif`},top:0,right:0,itemWidth:12,itemHeight:8},grid:{left:`3%`,right:`3%`,bottom:`8%`,top:`14%`,containLabel:!0},xAxis:{type:`category`,data:re,boundaryGap:!1,...N},yAxis:{type:`value`,...N},series:[{name:`订单量`,type:`line`,smooth:!0,symbol:`circle`,symbolSize:4,lineStyle:{width:2,color:wu},itemStyle:{color:wu},areaStyle:{color:{type:`linear`,x:0,y:0,x2:0,y2:1,colorStops:[{offset:0,color:`rgba(14,165,233,0.25)`},{offset:1,color:`rgba(14,165,233,0)`}]}},data:ie.value.orders},{name:`营收(万)`,type:`line`,smooth:!0,symbol:`diamond`,symbolSize:5,lineStyle:{width:2,color:Eu},itemStyle:{color:Eu},areaStyle:{color:{type:`linear`,x:0,y:0,x2:0,y2:1,colorStops:[{offset:0,color:`rgba(16,185,129,0.2)`},{offset:1,color:`rgba(16,185,129,0)`}]}},data:ie.value.revenue}]})),le=_(()=>({color:[wu,Eu,Ou,Du,Tu],tooltip:{...M,trigger:`item`,formatter:`{b}: {c} ({d}%)`},series:[{type:`pie`,radius:[`40%`,`68%`],center:[`50%`,`48%`],itemStyle:{borderColor:`rgba(15,23,42,0.9)`,borderWidth:2,borderRadius:6},label:{color:`rgba(255,255,255,0.5)`,fontSize:10,fontFamily:`Inter, sans-serif`,formatter:`{b}
{d}%`},labelLine:{lineStyle:{color:`rgba(255,255,255,0.1)`}},emphasis:{label:{fontSize:13,fontWeight:`bold`,color:`#fff`},itemStyle:{shadowBlur:16,shadowColor:`rgba(14,165,233,0.3)`}},data:ae.value}]})),ue=_(()=>({color:[wu],tooltip:{...M,trigger:`axis`,axisPointer:{type:`shadow`}},grid:{left:`3%`,right:`12%`,bottom:`6%`,top:`6%`,containLabel:!0},xAxis:{type:`value`,...N},yAxis:{type:`category`,data:[`配件`,`户外服饰`,`徒步装备`,`滑雪装备`,`上装`],...N,inverse:!0},series:[{type:`bar`,barWidth:14,itemStyle:{borderRadius:[0,6,6,0],color:{type:`linear`,x:0,y:0,x2:1,y2:0,colorStops:[{offset:0,color:`rgba(14,165,233,0.1)`},{offset:1,color:wu}]}},backgroundStyle:{color:`rgba(14,165,233,0.04)`,borderRadius:[0,6,6,0]},showBackground:!0,data:oe.value}]})),de=_(()=>({color:[Eu],tooltip:{...M,trigger:`axis`,axisPointer:{type:`shadow`}},grid:{left:`3%`,right:`12%`,bottom:`6%`,top:`6%`,containLabel:!0},xAxis:{type:`value`,...N},yAxis:{type:`category`,data:[`杭州旗舰`,`成都太古`,`北京三里`,`长春万达`,`哈尔滨中央`],...N,inverse:!0},series:[{type:`bar`,barWidth:14,itemStyle:{borderRadius:[0,6,6,0],color:{type:`linear`,x:0,y:0,x2:1,y2:0,colorStops:[{offset:0,color:`rgba(16,185,129,0.1)`},{offset:1,color:Eu}]}},backgroundStyle:{color:`rgba(16,185,129,0.04)`,borderRadius:[0,6,6,0]},showBackground:!0,data:P.value}]})),fe=_(()=>({color:[Ou],tooltip:{...M,trigger:`axis`},grid:{left:`3%`,right:`3%`,bottom:`8%`,top:`8%`,containLabel:!0},xAxis:{type:`category`,data:re,...N},yAxis:{type:`value`,...N},series:[{type:`bar`,barWidth:14,itemStyle:{borderRadius:[6,6,0,0],color:{type:`linear`,x:0,y:1,x2:0,y2:0,colorStops:[{offset:0,color:`rgba(139,92,246,0.1)`},{offset:1,color:Ou}]}},backgroundStyle:{color:`rgba(139,92,246,0.03)`,borderRadius:[6,6,0,0]},showBackground:!0,data:se.value}]})),pe=null;function F(e,t){return Math.round(e*(1+(Math.random()-.5)*2*t))}async function I(){k.value=[{label:`今日营收`,target:F(284600,.05),prefix:`¥`,suffix:``,trend:`+`+(10+Math.random()*5).toFixed(1)+`%`,trendClass:`up`,trendSub:`较昨日`},{label:`今日订单`,target:F(3472,.08),prefix:``,suffix:``,trend:`+`+(5+Math.random()*6).toFixed(1)+`%`,trendClass:`up`,trendSub:`较昨日`},{label:`活跃会员`,target:F(15680,.03),prefix:``,suffix:``,trend:`+`+(1+Math.random()*4).toFixed(1)+`%`,trendClass:`up`,trendSub:`较上周`},{label:`滑雪品类占比`,target:F(38,.05),prefix:``,suffix:`%`,trend:`+`+(1+Math.random()*2).toFixed(1)+`%`,trendClass:`up`,trendSub:`较上月`},{label:`门店数量`,target:128,prefix:``,suffix:`家`,trend:`+5`,trendClass:`up`,trendSub:`本季新增`},{label:`客单价`,target:F(528,.06),prefix:`¥`,suffix:``,trend:`+`+(4+Math.random()*5).toFixed(1)+`%`,trendClass:`up`,trendSub:`较上月`},{label:`退货率`,target:+(1.5+Math.random()*1.5).toFixed(1),prefix:``,suffix:`%`,trend:`-`+(Math.random()*.5).toFixed(1)+`%`,trendClass:`down`,trendSub:`较上月`}],j(),ie.value={orders:[1200,1890,1650,2380,2130,2910,2690,3250,3580,3140,3810,F(4250,.05)],revenue:[86,128,95,198,165,241,219,274,296,252,318,F(362,.05)]},ae.value=[{value:F(735,.05),name:`线上商城`},{value:F(580,.05),name:`线下门店`},{value:F(284,.05),name:`经销商`},{value:F(148,.05),name:`大客户`},{value:F(96,.05),name:`其他`}],oe.value=oe.value.map(e=>F(e,.04)),P.value=P.value.map(e=>F(e,.04)),se.value=se.value.map((e,t)=>t===se.value.length-1?F(e,.06):e),te.value=[{value:F(94,.02),max:100,title:`库存周转`,color:[`#0ea5e9`,`#0284c7`]},{value:F(87,.03),max:100,title:`订单完成率`,color:[`#10b981`,`#0ea5e9`]},{value:F(15680,.03),max:2e4,title:`会员总数`,color:[`#8b5cf6`,`#0ea5e9`]}]}return r(()=>{pe=setInterval(I,3e4)}),m(()=>{clearInterval(pe)}),(n,r)=>{let m=y;return s(),a(`div`,Vl,[r[22]||=i(`div`,{class:`topo-bg`},null,-1),i(`div`,Hl,[(s(),a(d,null,c(50,e=>i(`span`,{key:e,class:`snowflake`,style:p(O(e))},null,4)),64))]),i(`header`,Ul,[r[8]||=i(`div`,{class:`header-deco left-deco`},[i(`svg`,{width:`160`,height:`24`,viewBox:`0 0 160 24`,fill:`none`},[i(`path`,{d:`M0 18 L20 18 L28 8 L44 16 L56 6 L72 14 L88 4 L104 12 L120 8 L136 16 L148 6 L160 10`,stroke:`#0ea5e9`,"stroke-width":`1.2`,fill:`none`,opacity:`0.3`,"stroke-linecap":`round`,"stroke-linejoin":`round`})])],-1),i(`div`,Wl,[r[5]||=i(`h1`,{class:`header-title`},`BC Sport 数据驾驶舱`,-1),i(`div`,Gl,[r[0]||=i(`span`,{class:`status-dot`},null,-1),r[1]||=i(`span`,{class:`sub-text`},`SYSTEM ONLINE`,-1),r[2]||=i(`span`,{class:`sub-sep`},`·`,-1),i(`span`,Kl,h(T.value),1),r[3]||=i(`span`,{class:`sub-sep`},`·`,-1),r[4]||=i(`span`,{class:`sub-text`},`ELEV 2,180m`,-1)])]),r[9]||=i(`div`,{class:`header-deco right-deco`},[i(`svg`,{width:`160`,height:`24`,viewBox:`0 0 160 24`,fill:`none`},[i(`path`,{d:`M0 10 L12 6 L28 14 L44 4 L60 12 L76 8 L92 16 L108 6 L124 14 L140 4 L152 18 L160 18`,stroke:`#0ea5e9`,"stroke-width":`1.2`,fill:`none`,opacity:`0.3`,"stroke-linecap":`round`,"stroke-linejoin":`round`})])],-1),i(`button`,{class:`fullscreen-btn`,onClick:C,title:o.value?`退出全屏`:`全屏`},[o.value?(s(),a(`svg`,Yl,[...r[7]||=[i(`path`,{d:`M4 14h6v6`},null,-1),i(`path`,{d:`M20 10h-6V4`},null,-1),i(`path`,{d:`M14 10l7-7`},null,-1),i(`path`,{d:`M3 21l7-7`},null,-1)]])):(s(),a(`svg`,Jl,[...r[6]||=[i(`path`,{d:`M8 3H5a2 2 0 0 0-2 2v3`},null,-1),i(`path`,{d:`M21 8V5a2 2 0 0 0-2-2h-3`},null,-1),i(`path`,{d:`M3 16v3a2 2 0 0 0 2 2h3`},null,-1),i(`path`,{d:`M16 21h3a2 2 0 0 0 2-2v-3`},null,-1)]]))],8,ql)]),i(`div`,Xl,[i(`div`,Zl,[e(m,null,{default:l(()=>[e(t(x))]),_:1}),r[10]||=i(`span`,null,`BC-ALPINE-01`,-1)]),i(`div`,Ql,[e(m,null,{default:l(()=>[e(t(S))]),_:1}),r[11]||=i(`span`,null,`2,180m`,-1)]),i(`div`,$l,[e(m,null,{default:l(()=>[e(t(b))]),_:1}),r[12]||=i(`span`,null,`-4°C`,-1)]),r[13]||=i(`div`,{class:`hud-chip`},[i(`span`,null,`🏔`),i(`span`,null,`32cm SNOW`)],-1),r[14]||=i(`div`,{class:`hud-chip`},[i(`span`,null,`⛷`),i(`span`,null,`24/28 TRAILS`)],-1),r[15]||=i(`div`,{class:`hud-chip signal`},[i(`span`,{class:`signal-dot`}),i(`span`,null,`SIGNAL OK`)],-1)]),i(`div`,eu,[(s(!0),a(d,null,c(k.value,(e,t)=>(s(),a(`div`,{key:e.label,class:`kpi-card`,style:p({animationDelay:.06*t+`s`})},[i(`div`,tu,h(e.label),1),i(`div`,nu,h(e.prefix)+h(A.value[e.label])+h(e.suffix),1),i(`div`,{class:u([`kpi-trend`,e.trendClass])},[i(`span`,ru,h(e.trendClass===`up`?`↗`:e.trendClass===`down`?`↘`:`→`),1),f(` `+h(e.trend)+` `,1),i(`span`,iu,h(e.trendSub),1)],2)],4))),128))]),i(`div`,au,[i(`div`,ou,[i(`div`,su,[r[16]||=i(`div`,{class:`panel-header`},[i(`span`,{class:`panel-indicator`}),i(`span`,{class:`panel-title`},`营收趋势`),i(`span`,{class:`panel-tag`},`LIVE`)],-1),i(`div`,cu,[e(t(g),{option:ce.value,autoresize:``},null,8,[`option`])])]),i(`div`,lu,[r[17]||=i(`div`,{class:`panel-header`},[i(`span`,{class:`panel-indicator`}),i(`span`,{class:`panel-title`},`渠道分布`),i(`span`,{class:`panel-tag`},`MIX`)],-1),i(`div`,uu,[e(t(g),{option:le.value,autoresize:``},null,8,[`option`])])]),i(`div`,du,[r[18]||=i(`div`,{class:`panel-header`},[i(`span`,{class:`panel-indicator`}),i(`span`,{class:`panel-title`},`品类排行`),i(`span`,{class:`panel-tag`},`RANK`)],-1),i(`div`,fu,[e(t(g),{option:ue.value,autoresize:``},null,8,[`option`])])])]),i(`div`,pu,[i(`div`,mu,[r[19]||=i(`div`,{class:`panel-header core-header`},[i(`span`,{class:`panel-indicator`}),i(`span`,{class:`panel-title`},`山地核心`),i(`span`,{class:`panel-tag`},`3D`)],-1),e(Bl,{class:`core-earth`})]),i(`div`,hu,[i(`div`,gu,[(s(!0),a(d,null,c(te.value,(t,n)=>(s(),a(`div`,{key:t.title,class:`gauge-item`,style:p({"--g-delay":n*.12+`s`})},[e(w,{value:t.value,max:t.max,title:t.title,color:t.color},null,8,[`value`,`max`,`title`,`color`])],4))),128))]),i(`div`,_u,[(s(!0),a(d,null,c(ne.value,(e,t)=>(s(),a(`div`,{key:e.label,class:`core-kpi-item`},[i(`span`,vu,h(e.label),1),i(`span`,{class:u([`core-kpi-value`,e.trendClass])},h(e.prefix)+h(e.value)+h(e.suffix),3)]))),128))])])]),i(`div`,yu,[i(`div`,bu,[r[20]||=i(`div`,{class:`panel-header`},[i(`span`,{class:`panel-indicator`}),i(`span`,{class:`panel-title`},`会员增长`),i(`span`,{class:`panel-tag`},`TREND`)],-1),i(`div`,xu,[e(t(g),{option:fe.value,autoresize:``},null,8,[`option`])])]),i(`div`,Su,[r[21]||=i(`div`,{class:`panel-header`},[i(`span`,{class:`panel-indicator`}),i(`span`,{class:`panel-title`},`门店排行`),i(`span`,{class:`panel-tag`},`TOP5`)],-1),i(`div`,Cu,[e(t(g),{option:de.value,autoresize:``},null,8,[`option`])])])])])])}}}),[[`__scopeId`,`data-v-510b8497`]]);export{ku as default};